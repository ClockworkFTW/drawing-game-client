...
const Logo = () => (
  <Container>
    ...
    <span style={{ color: "#00cc00", textShadow: "3px 3px #005610" }}>a</span>
    <span style={{ color: "#05b2ff", textShadow: "3px 3px #01569e" }}>w</span>
    <span style={{ color: "#231fd3", textShadow: "3px 3px #0e0765" }}>l</span>
    <span style={{ color: "#a300bb", textShadow: "3px 3px #550069" }}>d</span>
